...
using ServiceReservasi_087;
using System.ServiceModel.Description;
using System.ServiceModel.Channels;

namespace ServerReservasi_087
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri address = new Uri("http://localhost:8733/Design_Time_Addresses/ServiceReservasi_087/Service1/mex");
